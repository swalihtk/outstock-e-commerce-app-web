  ...
  return (
    <div>
      <Nav variant="tabs" defaultActiveKey="/home">
        <Nav.Item>
          <Nav.Link eventKey="link-1" onClick={changeToCreate}>
            Create Category
          </Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-2" onClick={changeToUpdate}>
            Update Category
          </Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-3" onClick={changeToDelete}>
            Delete Category
          </Nav.Link>
        </Nav.Item>
      </Nav>
      ...
      <div style={{ background: "white", height: "80vh" }}>
        {categoyState === "create" ? (
          ...
          categoyState === "delete" && <CategoryDelete />
        )}
      </div>
    </div>
  );
